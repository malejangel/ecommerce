...
public class OrderControler {
    ...
    public String createOrder(RedirectAttributes attributes, HttpSession httpSession, Model model){
        ...
        String mensaje="Compra realizada con exito";
        model.addAttribute("mensaje",mensaje);
        attributes.addFlashAttribute("mensaje", mensaje);
        return "redirect:/user/order/sumary-order?success=true";
    }
