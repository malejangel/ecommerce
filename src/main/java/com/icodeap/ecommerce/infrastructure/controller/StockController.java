...
public class StockController {
    ...
    public String save(Stock stock, @RequestParam("idproduct") Integer idproduct, RedirectAttributes flash, Model model){
        ...
        String mensaje ="Unidades guardadas con exito";
